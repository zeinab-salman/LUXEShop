...
export default function ChartComponent() {
  ...
  ].map(day => chartData.find(item => item.day === day) || { day, total: 0 });

  return (
    <section className="line-section flex-center" style={{ width: '100%', overflowX: 'auto' }}>
      <Title title="Sales Overview: Weekly sales comparison"
        line="line-sec"
