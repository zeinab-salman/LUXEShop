...
import ProductCom from "../../Ui/productCom/ProductCom";
...
const CollectiosSection = () => {
  ...
  const categories = [...new Set(ProductsData.map((item) => item.categor))];

  const filteredProducts =
    activeCategory === "all"
      ? ProductsData
      : ProductsData.filter((item) => item.categor === activeCategory);
