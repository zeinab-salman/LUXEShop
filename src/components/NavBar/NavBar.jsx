...
export default function NavBar() {
  ...
  return (
    <>
      <nav className={` nav-3d z-navbar   ${mascroll ? "z-nav2 " : ""}`}>
        ...
        <ul className={`z-links ${maisopen ? "z-link-open" : ""}`}>
          <li className="li-nav1">
            <NavLink to={"/"} className="z-home" onClick={listdown}>
              Home
            </NavLink>
          </li>
          <li className="li-nav1">
            <NavLink to={"/Login"} onClick={listdown}>
              Login
            </NavLink>
          </li>

          <li className="li-nav1">
            <NavLink to={"/Products"} className="z-details" onClick={listdown}>
              Products
            </NavLink>
          </li>
          <li className="li-nav1">
            <NavLink to={"/About"} className="z-details" onClick={listdown}>
              About
            </NavLink>
          </li>
          <li className="li-nav1">
            <NavLink to={"/Contact"} className="z-details" onClick={listdown}>
              Contact
            </NavLink>
          </li>
          <li className="li-nav1">
          ...
          {user ? (
            <>
              ...
              <ul
                className={` user-list glass-effect ${listOpen ? "list-none" : ""}`}
              >
      ...
      />
      <WalletModel isOpen={walletOpen} onClose={() => setWalletOpen(false)} />
    </>
  );
}
